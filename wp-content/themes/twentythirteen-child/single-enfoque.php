...
?>	
			...
			<div class="boxSep">
    			<div class="imgLiquidFill imgLiquid">
       				...
       				<?php echo wp_get_attachment_image( get_field('main_image'), 'full' ); ?>
        				...
        				<header class="entry-header" style="width: 100%; text-align: center; position:relative; top: 70vh;color:#fff">
							...
							<div class="author-cat" style="margin:0; color:#fff">
    			...
    			<div style="position: absolute; bottom: 5vh;right: 0">
    			...
    			<div style="position: absolute; width: 100%; text-align: right; padding-right: 10px;">
    				<p style="color:#3c3c3c; font-size:15px; font-family: 'Helvetica', Helvetica, Arial, 'Lucida Grande', sans-serif">Foto por <?php the_field('photo_byline'); ?></p>
    			</div>
